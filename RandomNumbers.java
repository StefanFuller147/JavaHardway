public class RandomNumbers {
	public static void main (String [] args) {
		...
		rps = Math.random();
		if ( rps < 0.3333333 ) { //will be true 1/4 of the time
		...
		// pick a single random integers, each 1-100
